...
Les références telles que @baumer2015Markdown renvoient vers la bibliographie en fin de document (cliquable si le document est en affichage long).
...
- ceci permet d'assurer la reproductibilité des résultats [@baumer2015Markdown] et assure que les données répondent à la notion [FAIR](https://fr.wikipedia.org/wiki/Fair_data) (Facile à trouve, Accessible,Interopérable et Réutilisable)
